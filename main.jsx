...
export default function App() {
  ...
  const communityImpact = (amount * 0.05).toFixed(2); // 5% investment toggle
    ...
    <div className="font-sans bg-gray-50 text-gray-900">
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg">
          The Black diaspora sends over <strong>$50B annually</strong> to Africa
          & the Caribbean. Fees average <strong>7–10% per transfer</strong>. Families
          need money today, but communities also need long-term investment.
        </p>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-100 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-6 bg-white rounded-2xl shadow">
            ...
            <p>A simple toggle lets senders direct part of each transfer into pooled smart contracts funding schools, clinics, and businesses.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-100 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-6 bg-white rounded-2xl shadow">
            ...
            <p>2% fee model → $54M yearly revenue at scale.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow">
          ...
          <table className="table-auto mx-auto border-collapse border border-gray-300">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border px-4 py-2">None</td>
                <td className="border px-4 py-2 font-bold text-green-600">Yes</td>
              </tr>
              <tr>
                <td className="border px-4 py-2">Transparency</td>
                <td className="border px-4 py-2">Limited</td>
                <td className="border px-4 py-2">Limited</td>
                <td className="border px-4 py-2 font-bold text-green-600">Full</td>
              </tr>
            </tbody>
          </table>
        </div>
